...
public interface PedidoRepository extends JpaRepository<Pedido, Long> {
    ...
    // 3. Adicionado "AND p.status <> 'CANCELADO'" para ignorar pedidos cancelados no faturamento
    ...
    // 4. Agrupa as vendas por data para achar o dia com maior pico (Ignorando cancelados)
    ...
    // 5. Busca o Top 5 produtos mais vendidos do período
